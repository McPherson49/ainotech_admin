                            ...
                            <div class="main-content-wrap">
                                <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                                    ...
                                    <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                                        ...
                                        <li>
                                            <a href="#"><div class="text-tiny">Discount</div></a>
                                        </li>
                                        <li>
                                            <i class="icon-chevron-right"></i>
                                        </li>
                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" >
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Discount Code" name="text" tabindex="0" value="" aria-required="true" required="">
                                        </fieldset>
                                        <div class="bot">
                                            <div></div>
                                            <button class="tf-button w208" type="submit">Create Discount Code</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
